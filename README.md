...
- `public/` — file statis berupa assets
...
- **TailwindCSS** membantu proses styling menjadi lebih mudah, cepat, dan menarik  
...
```bash
git clone https://github.com/rifqiadrianto007/React_Portofolio
cd React_Portofolio
````
...
[🔗 Lihat versi live]([https://username.github.io/portofolio/](https://rifqi-adrianto.vercel.app/))

## Tentang Saya

Hi, saya Rifqi Adrianto (username GitHub: `rifqiadrianto007`).
